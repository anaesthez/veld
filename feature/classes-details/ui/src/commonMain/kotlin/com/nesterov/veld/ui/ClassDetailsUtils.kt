...
inline fun HitDiceType.getDiceImageByType(): Image =
    when (this) {
        HitDiceType.EMPTY -> DesignImages.dice_8
        HitDiceType.DICE_4 -> DesignImages.dice_8
        HitDiceType.DICE_6 -> DesignImages.dice_8
        HitDiceType.DICE_8 -> DesignImages.dice_8
        HitDiceType.DICE_10 -> DesignImages.dice_8
        HitDiceType.DICE_12 -> DesignImages.dice_8
    }
